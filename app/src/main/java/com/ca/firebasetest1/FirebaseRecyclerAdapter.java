 ...
 */
abstract class FirebaseRecyclerAdapter<ViewHolder extends RecyclerView.ViewHolder, T>
     ...
     */
    FirebaseRecyclerAdapter(Query query, Class<T> itemClass, Firebase ref) {
     ...
     */
    private FirebaseRecyclerAdapter(Query query, Class<T> itemClass,
